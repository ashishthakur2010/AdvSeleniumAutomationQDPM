...
public class ExtentReportNG {
    ...
    public static ExtentReports setupExtentReport() throws Exception {
        ...
        extent.setSystemInfo("Executed on Environment: ", ReadProperties.getPropertyValueByKey("url"));
        extent.setSystemInfo("Executed on Browser: ", ReadProperties.getPropertyValueByKey("browser"));
