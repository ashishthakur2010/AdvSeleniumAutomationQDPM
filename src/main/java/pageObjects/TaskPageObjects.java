...
public class TaskPageObjects extends TestBase {
    ...
    public void createTask(HashMap<String, String> testData) throws Throwable {
        ...
        clickOn(DriverFactory.getInstance().getDriver().findElement(btn_save), "NewTaskSaveButton");

    }

    public void Search_Verify_TaskCreationOnUI(HashMap<String, String> testData) throws Throwable {

        mouseHoverElement(DriverFactory.getInstance().getDriver().findElement(field_Search), "TaskSearchOption");
        type(DriverFactory.getInstance().getDriver().findElement(txt_Search), "TaskSearchBox", testData.get("TaskName"));
        clickOn(DriverFactory.getInstance().getDriver().findElement(btn_Search), "SearchButton");
